...
('roman@test.com', 'email', 1),
('Noviy Rozdol city, Test street', 'address', 1),
...
# From CLI (not MySQL)
# mysqldump -uroot skillup_db > /var/lib/mysql/skillup_db.23150625.sql   /*мало бути 27 число а не 25*/
